...
Q_IMPORT_QML_PLUGIN(HeliContentPlugin)
Q_IMPORT_QML_PLUGIN(Generated_QtQuick3D_MD_902_ExplorerPlugin)
Q_IMPORT_QML_PLUGIN(HeliPlugin)

const char mainQmlFile[] = "qrc:/qt/qml/HeliContent/App.qml";
